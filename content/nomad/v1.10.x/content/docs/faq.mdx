...
Isso significa que, por padrão, suas tasks do Docker não poderão acessar
...
Agora seus serviços serão registrados no Consul usando o IP correto e suas tasks
poderão se comunicar.
Para acessar suas tasks a partir da sua máquina host, você precisará usar o
