...
representation of a value use [`jsonencode`](/nomad/docs/job-specification/hcl2/functions/encoding/jsonencode) instead; its
...
[`jsonencode`](/nomad/docs/job-specification/hcl2/functions/encoding/jsonencode) instead: YAML flow-style is a superset
of JSON syntax.

## Related Functions

- [`jsonencode`](/nomad/docs/job-specification/hcl2/functions/encoding/jsonencode) is a similar operation using JSON instead
  of YAML.
- [`yamldecode`](/nomad/docs/job-specification/hcl2/functions/encoding/yamldecode) performs the opposite operation, _decoding_
