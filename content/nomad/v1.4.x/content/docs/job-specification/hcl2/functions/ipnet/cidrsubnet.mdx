...
Unlike the related function [`cidrsubnets`](/nomad/docs/job-specification/hcl2/functions/ipnet/cidrsubnets), `cidrsubnet`
...
While [`cidrhost`](/nomad/docs/job-specification/hcl2/functions/ipnet/cidrhost) allows calculating single host IP addresses,
...
[`cidrhost`](/nomad/docs/job-specification/hcl2/functions/ipnet/cidrhost) function to calculate those host addresses by
...
- [`cidrsubnets`](/nomad/docs/job-specification/hcl2/functions/ipnet/cidrsubnets) can allocate multiple consecutive
