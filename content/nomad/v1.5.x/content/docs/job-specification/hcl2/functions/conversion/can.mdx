...
[`try`](/nomad/docs/job-specification/hcl2/functions/conversion/try) instead, because it allows for more concise definition of
...
prefer to use [`try`](/nomad/docs/job-specification/hcl2/functions/conversion/try).
...
- [`try`](/nomad/docs/job-specification/hcl2/functions/conversion/try), which tries evaluating a sequence of expressions and
