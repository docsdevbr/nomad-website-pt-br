...
- [`formatdate`](/nomad/docs/job-specification/hcl2/functions/datetime/formatdate) is a specialized formatting function for
  human-readable timestamps.
- [`formatlist`](/nomad/docs/job-specification/hcl2/functions/string/formatlist) uses the same specification syntax to
