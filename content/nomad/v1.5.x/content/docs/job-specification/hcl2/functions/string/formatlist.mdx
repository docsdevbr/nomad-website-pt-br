...
[the same syntax as `format`](/nomad/docs/job-specification/hcl2/functions/string/format#specification-syntax).
...
- [`format`](/nomad/docs/job-specification/hcl2/functions/string/format) defines the specification syntax used by this
