...
- [`index`](/nomad/docs/job-specification/hcl2/functions/collection/index-fn) finds the index for a particular element value.
- [`lookup`](/nomad/docs/job-specification/hcl2/functions/collection/lookup) retrieves a value from a _map_ given its _key_.
