...
- `ConsulToken` `(string:"")` - Optional value specifying the [consul token](/nomad/commands/job/revert)
  used for Consul [service identity polity authentication checking](/nomad/docs/configuration/consul#allow_unauthenticated).

- `VaultToken` `(string: "")` - Optional value specifying the [vault token](/nomad/commands/job/revert)
