...
returned from [`keys`](/nomad/docs/job-specification/hcl2/functions/collection/keys).
...
- [`keys`](/nomad/docs/job-specification/hcl2/functions/collection/keys) returns a list of the _keys_ from a map.
