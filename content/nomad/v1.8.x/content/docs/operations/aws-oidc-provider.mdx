...
- Your AWS account has the necessary permissions to create IAM roles, policies, hosted zones,
  and certificates.
- Terraform is installed locally and
  [configured to communicate with AWS](https://registry.terraform.io/providers/hashicorp/aws/latest/docs#authentication-and-configuration).
