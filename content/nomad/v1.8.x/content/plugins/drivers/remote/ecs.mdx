...
~> **Deprecation Warning!**
The `ecs` driver is currently deprecated. We will not prioritize features or pull requests that affect the ecs driver. The external driver is available as an [open source
repository](https://github.com/hashicorp/nomad-driver-ecs) for community ownership.
