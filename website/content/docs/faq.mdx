...
Não.
Para aqueles familiarizados com o Consul,
...
Normalmente, esses são valores que devem ser consistentes entre os membros do
servidor.
Por exemplo, a opção [`default_scheduler_config`] permite que um operador defina
o SchedulerConfig com valores não padrão durante esse processo de inicialização,
em vez de exigir uma chamada imediata à API assim que o cluster estiver
...
Assim que estiver mais familiarizado com o Nomad, você poderá começar a
executá-lo nativamente.
