...
Server agents are part of the [consensus protocol](/nomad/docs/concepts/consensus) and
[gossip protocol](/nomad/docs/concepts/gossip). The consensus protocol, powered
...
the host machine, as well as what [drivers](/nomad/docs/drivers) are available.
...
Start the agent with the [`nomad agent` command](/nomad/docs/commands/agent).
...
attributes, capabilities, and [task drivers](/nomad/docs/drivers). The client
